...
'use server';
/**
 * @fileOverview A Genkit flow to fetch commercial dashboard data.
 *
 * This file defines the data structures and the flow for retrieving
...
export async function getCommercialData(): Promise<CommercialData> {
  return getCommercialDataFlow();
}

// Define the Genkit flow
const getCommercialDataFlow = ai.defineFlow(
  {
    name: 'getCommercialDataFlow',
    outputSchema: CommercialDataSchema,
  },
  async () => {
    //
