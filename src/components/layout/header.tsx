    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center">
        <Link href="/dashboard" className="mr-6 flex items-center space-x-2">
          ...
          <Image
            src="https://placehold.co/32x32.png" // Placeholder image
            alt="Banesco Seguros Logo"
            width={32} // Corresponds to h-8 (2rem = 32px)
            height={32} // Assuming a square aspect ratio for the logo
            data-ai-hint="logo banesco" // Hint for AI to find appropriate image
          />
          {/* 
            Original SVG for reference (now removed):
